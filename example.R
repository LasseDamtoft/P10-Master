...
graph = graph_loader()
example_vehicles = vehicle_loader()
example_graph = graph %>% 
  slice(1:15)
...
example_graph$Width = c(3,3,3,3,6,6,6,6,6,3,6,3,3,6,3)*2

# example_vehicles$spreadwidth = c(12,6)
# example_vehicles$ID = c(2,1)
example_vehicles = example_vehicles %>% mutate(service_speed = ifelse(vehicle == 'Traktor', 15,30))

# xample_vehicles$service_speed = c(30,15)
example_vehicles$deadhead_speed = example_vehicles$service_speed*2
